...
- `spacetimedb/` is the backend/runtime direction for live-room state.
- `fly.toml` is a legacy artifact and should not be used for new backend/runtime deployment work.
